          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 mb-4 space-y-2">
                <li>
                  <strong>Account Information:</strong> Email address, organization name, password
                  (hashed)
                </li>
                <li>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 mb-4 space-y-2">
                ...
                <li>
                  <strong>Analytics Data:</strong> Aggregated after 1 year, raw data deleted after 2
                  years
                </li>
                <li>
